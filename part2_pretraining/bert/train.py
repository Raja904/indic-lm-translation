...
def main():
    parser = argparse.ArgumentParser(description="BERT-style Pretraining")
    parser.add_argument("--config", type=str, default="configs/part2/bert_base.yaml", help="Path to config file")
